    ...
    return (
        <>
            <div className="d-flex sub-bg align-items-center justify-content-center">
                <div className="sub-title fs-2">Beli Dana E-WALLET</div>
            </div>
...
shopee.layout = (page) => <Subtemplate children={page} title="topup" />;
