    ...
    return (
        <>
            <div className="d-flex sub-bg align-items-center justify-content-center">
                <div className="sub-title fs-2">Beli Paket Data</div>
            </div>
                    ...
                    <form onSubmit={submit}>
                        <div className="card-body">
                            <div className="form-group">
                                <label>Masukan No Telphone</label>
                                <input
                                    type="tel"
...
internet.layout = (page) => <Subtemplate children={page} title="topup" />;
